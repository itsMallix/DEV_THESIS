...
describe("Crowdfunding", function () {
    ...
    it("Should not allow create campaign with past deadline", async function () {
        ...
        ).to.be.revertedWith("The deadline should be a date in the future"); // ✅ Fixed
    });
    ...
    it("Should allow donations to an active campaign", async function () {
        ...
        await crowdfunding.connect(addr1).donateToCampaign(0, { value: ethers.parseEther("1.0") });
        await crowdfunding.connect(addr2).donateToCampaign(0, { value: ethers.parseEther("1.0") });
